...
class Usser {
    ...
    hobbies = []; // public/private marked properties affects how properties are accessed in/outside of the class. Readonly can be read and it can be accessed but it can't be re-assigned with an equal sign (can push to arrays tho)
